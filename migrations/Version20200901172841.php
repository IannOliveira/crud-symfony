...
final class Version20200901172841 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE cliente (id INT AUTO_INCREMENT NOT NULL, cod BIGINT NOT NULL, nome VARCHAR(255) NOT NULL, nascimento DATE NOT NULL, cpf VARCHAR(14) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE endereco (id INT AUTO_INCREMENT NOT NULL, cod_cliente_id INT NOT NULL, cod BIGINT NOT NULL, logradouro VARCHAR(500) NOT NULL, numero_imovel INT NOT NULL, complemento VARCHAR(500) DEFAULT NULL, bairro VARCHAR(500) NOT NULL, cidade VARCHAR(500) NOT NULL, estado VARCHAR(255) NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_F8E0D60EF56F84EC ON endereco (cod_cliente_id)');
        $this->addSql('CREATE TABLE acesso (id INT AUTO_INCREMENT NOT NULL, cod_cliente_id INT NOT NULL, cod BIGINT NOT NULL, email VARCHAR(250) NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
